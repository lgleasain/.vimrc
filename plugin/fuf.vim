...
function s:initialize()
  ...
  call l9#defineVariableDefault('g:fuf_file_exclude'    , '\v\~$|\.(o|exe|dll|bak|orig|pdf|gif|jpeg|jpg|png|JPG|extra|sw[po])$|(^|[/\\])\.(hg|git|bzr|tmp|DS_Store|idea)($|[/\\])|(^|[/\\])(tmp|vendor|pics)($|[/\\])')
  "---------------------------------------------------------------------------
  ...
  call l9#defineVariableDefault('g:fuf_dir_exclude'    , '\v(^|[/\\])\.(hg|git|bzr|tmp|pics)($|[/\\])')
  "---------------------------------------------------------------------------
